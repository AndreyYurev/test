...
<body>
        ...
        <div class="container">
            <section class="users">
                ...
                ?>
                    ...
                    <a class="logout" href="./php/logout.php?logout_id=<?php echo $row['unique_id'] ?>">Выйти</a>
                </header>
                <div class="search">
                    <span class="text">Выберите тему для общения</span>
    ...
    <script src="./js/path-show-hide.js"></script>
